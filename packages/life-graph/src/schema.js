...
export const LIFE_GRAPH_VERSION = '0.1.0';
...
export const LegacyLocalLifeGraphSchema = z
    ...
    .strict();
export function parseVersionedLifeGraphDocument(value) {
    return LifeGraphDocumentSchema.parse(value);
}
export function parseGoalPlan(value) {
    return GoalPlanSchema.parse(value);
}
export function parseTask(value) {
    return LifeGraphTaskSchema.parse(value);
}
