...
test('household object schemas parse valid payloads and reject missing required fields', () => {
  const schemaCases = [
    ...
    {
      schema: HouseholdAutomationFailedSchema,
      valid: {
        household_id: 'house_1',
        actor_id: 'system',
        action_type: 'household.reminder.fire',
        error_code: 'REMINDER_NO_TOKEN',
        fix_suggestion: 'Check notification settings for admin-1',
        span_id: 'span_1',
        trace_id: 'trace_1',
        object_id: 'reminder_1',
        object_ref: 'reminder:reminder_1',
      },
      missingField: 'error_code',
    },
    {
