...
export default function ApprovalDetailModal() {
  ...
  const deadlineInfo = typeof approvalData.deadline === "number" ? formatDeadline(approvalData.deadline) : null;
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: palette.background.primary }]}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={[styles.actionBadge, { backgroundColor: palette.accent.brand }]}> 
          <Text style={[styles.actionText, { color: palette.background.primary }]}>{approvalData.action}</Text>
        </View>
        ...
        {Object.entries(approvalData.context ?? {}).map(([key, value]) => (
          <View key={key} style={[styles.contextRow, { borderColor: palette.border.default }]}> 
            ...
            <Text style={[styles.contextValue, { color: palette.text.primary }]}>{formatContextValue(value)}</Text>
          </View>
        ))}
        ...
        <Text style={[styles.reasonLabel, { color: palette.text.secondary }]}>Reason for rejection (optional)</Text>
        <TextInput
          style={[
            styles.reasonInput,
            {
